...
const scenarios = [
  {
    title: 'Scenarios: Lorem Ipsum is simply dummy text of the printing and',
...
const PracticeSection = () => (
  <section className="w-full bg-white rounded-2xl py-16 flex flex-col items-center justify-between font-sans">
    ...
    <div className="flex flex-col lg:flex-row gap-12 w-full max-w-7xl items-center justify-center">
      {/* Left: Image Only */}
      <div className="flex-1 flex justify-center items-center w-full">
        {/* <div className="w-full h-full flex items-center justify-center bg-[#FFF6F6] border border-[#F8D2D2] rounded-2xl"> */}
          <Image src="/assets/images/practiceimage.png" alt="Practice Test" width={630} height={428} className="rounded-xl object-fit w-full h-auto" />
        {/* </div> */}
      </div>
